...
#### HTTP (`itip/itip-frameworks/def/http/` — vendored to operator classpath)
...
Kafka, AMQP, gRPC, GraphQL, JDBC, WebSocket archetype families are reserved under `itip/itip-frameworks/def/{family}/`. Not yet implemented.
...
│   # WebSocket) are owned by ITIP — see itip/itip-frameworks/def/{family}/.
